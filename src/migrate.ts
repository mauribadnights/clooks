// cchooks migration utilities — convert shell hooks to HTTP hooks
...
/**
 * Migrate Claude Code settings.json command hooks to cchooks HTTP hooks.
 *
...
export function migrate(): { manifestPath: string; settingsPath: string; handlersCreated: number } {
  ...
  const yamlStr =
    '# cchooks manifest — auto-generated by migrate\n' +
  ...
  for (const eventName of HOOK_EVENTS) {
    ...
    if (eventName === 'SessionStart') {
      hookEntries.push({
        type: 'command',
        command: 'cchooks ensure-running',
      });
    }
